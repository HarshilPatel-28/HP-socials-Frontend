      ...
      <Card className='card h-screen flex flex-col justify-between py-5'>
        <div className='space-y-8 pl-5'>
          <div className=''>
            ...
            <span className="logo font-bold text-xl">HP Social</span>
          </div>
          <div className='space-y-8'>
{
  navigationMenu.map((item)=> <div onClick={()=>handleNavigate(item)} className='flex space-x-3 items-center cursor-pointer'>
    {item.icon}
